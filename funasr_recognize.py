...
# 模型目录
model_dir = "D:\Desktop\project\SenseVoice\SenseVoiceSmall"
vad_model_dir = "D:\Desktop\project\SenseVoice\speech_fsmn_vad_zh-cn-16k-common-pytorch"
...
if __name__ == "__main__":
    while True:
        ...
        if audio_buffer is not None:
            text = transcribe_audio(audio_buffer)  # 识别音频
            print(text)  # 输出识别结果
